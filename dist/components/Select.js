...
const List = _styledComponents.default.ul(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n    position: absolute;\n    top: calc(35px + ", ");\n    left: 0;\n    padding: 0;\n    margin: 0;\n    list-style: none;\n    background-color: ", ";\n    box-shadow: ", ";\n    width: 100%;\n    border-radius: ", ";\n    overflow: hidden;\n    z-index: 10;\n    transition: ", ";\n    max-height: ", ";\n    overflow-y: scroll;\n"])), _Variables.default.Spacers.XS, _Variables.default.Colors.White, _Variables.default.Shadows.S, _Variables.default.Radiuses.M, _Variables.default.Transitions.Short, props => props.isOpen ? "200px" : 0);
