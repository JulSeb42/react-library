...
const Button = _styledComponents.default.button(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    --size: 32px;\n    width: var(--size);\n    height: var(--size);\n    border-radius: 50%;\n    border: none;\n    font-size: ", ";\n    line-height: ", ";\n    font-family: ", ";\n    font-weight: ", ";\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    background: none;\n    color: ", ";\n    transition: ", ";\n\n    &:hover {\n        background-color: ", ";\n        color: ", ";\n    }\n\n    &:active {\n        background-color: ", ";\n        color: ", ";\n    }\n\n    &:disabled {\n        color: ", ";\n        background-color: transparent;\n    }\n\n    ", "\n\n    ", "\n"])), _Variables.default.FontSizes.Body, _Variables.default.FontSizes.Body, _Variables.default.FontFamilies.Body, _Variables.default.FontWeights.Bold, _Variables.default.Colors.Primary500, _Variables.default.Transitions.Short, _Variables.default.Colors.Primary300, _Variables.default.Colors.White, _Variables.default.Colors.Primary600, _Variables.default.Colors.White, _Variables.default.Colors.Gray500, props => props.active && (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n            background-color: ", ";\n            color: ", ";\n\n            &:hover {\n                background-color: ", ";\n            }\n        "])), _Variables.default.Colors.Primary500, _Variables.default.Colors.White, _Variables.default.Colors.Primary300), props => props.more && (0, _styledComponents.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            cursor: default;\n\n            &:hover {\n                background-color: transparent;\n                color: ", ";\n            }\n        "])), _Variables.default.Colors.Primary500));

const PaginationButton = props => {
  return /*#__PURE__*/_react.default.createElement(Button, props, props.prev && (props.customIconPrev ? /*#__PURE__*/_react.default.createElement(_Icon.default, {
    ...
    fill: "currentColor"
  }))), props.more && (props.customIconMore ? /*#__PURE__*/_react.default.createElement(_Icon.default, {
    ...
    fill: "currentColor"
  }))), props.number && props.number, props.next && (props.customIconNext ? /*#__PURE__*/_react.default.createElement(_Icon.default, {
