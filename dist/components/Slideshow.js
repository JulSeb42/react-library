...
function SlideshowButton(props) {
  return /*#__PURE__*/React.createElement(SlideshowButtonContainer, _extends({
    type: "button"
  }, props), props.type === "prev" && (props.customiconprev ? /*#__PURE__*/React.createElement(_Icon.default, {
    ...
    fill: "currentColor"
  }))), props.type === "next" && (props.customiconnext ? /*#__PURE__*/React.createElement(_Icon.default, {
