...
// Styles
const BasicContainer = _styledComponents.default.div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n    background-color: ", ";\n    padding: ", ";\n    box-shadow: ", ";\n    border-radius: ", ";\n    max-width: 300px;\n    text-decoration: none;\n    color: ", ";\n\n    ", "\n\n    ", "\n    \n    ", "\n"])), Variables.Colors.White, Variables.Margins.M, Variables.Shadows.S, Variables.Radiuses.M, Variables.Colors.Black, props => props.direction === "portrait" && (0, _styledComponents.css)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n            display: grid;\n            gap: ", ";\n            justify-items: center;\n        "])), Variables.Margins.XS), props => props.direction === "landscape" && (0, _styledComponents.css)(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n            display: flex;\n            align-items: center;\n\n            .icon {\n                margin-right: ", ";\n            }\n        "])), Variables.Margins.S), props => props.to && (0, _styledComponents.css)(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n            transition: ", ";\n\n            &:hover {\n                transform: scale(1.01);\n                box-shadow: ", ";\n            }\n        "])), Variables.Transitions.Short, Variables.Shadows.M));
